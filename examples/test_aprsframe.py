...
def test_frame1():
    ...
    frame_ascii_decoded = Frame(frame_ascii)
    frame_raw_decoded = Frame(frame_raw)
...
def test_frame2():
    ...
    frame__ok_decoded = aprs.Frame(frame__ok.decode('hex'))
    ...
    frame_bad_decoded = aprs.Frame(frame_bad.decode('hex'))
